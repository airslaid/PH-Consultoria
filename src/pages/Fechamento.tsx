        ...
        <div className="flex flex-col gap-6">
          {resumo.map(cli => (
            <div key={cli.id} className="glass-panel overflow-hidden" style={{ padding: 0 }}>
              <div className="flex justify-between items-center p-3 px-6 bg-black/20" style={{ borderBottom: '1px solid var(--border-color)', width: '100%' }}>
                ...
                <div className="flex gap-8 font-bold text-sm">
                  ...
                  <span style={{ color: 'var(--primary)', minWidth: '110px', textAlign: 'right' }}>R$ {cli.valorTotalCliente.toLocaleString('pt-BR', {minimumFractionDigits: 2})}</span>
                </div>
              </div>
              <div className="p-2">
